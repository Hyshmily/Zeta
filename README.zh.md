...
- 潮汐节奏是自适应的：`TidePacer`（热点先导）将交付积压折叠成快攻/慢放的平滑节奏——突发潮汐把周期缩短至 50ms，空闲潮汐则加倍拉长；`MoonsTidalForce`（月球潮汐引力修正）在续热键受阻时把提升门槛降到直方图边界直接接纳，而非棘轮式上调。提升边界本身按密度细化：边界桶溢出剩余热槽时，线性子直方图把阈值落到真实的第 k 大计数，且续热成员先于新来者被重新提升——平坦分布下热集保持稳定，而非每潮汐轮换随机样本
