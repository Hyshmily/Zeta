...
public class BenchController {
  ...
  public Optional<String> getHit(@PathVariable String key) {
    return zeta.get(key, () -> redisTemplate.opsForValue().get(key));
  }
  ...
  public Optional<String> getSoft(@PathVariable String key) {
    return zeta.getWithSoftExpire(key, () -> redisTemplate.opsForValue().get(key));
  }
