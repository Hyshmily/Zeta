...
class ReportConsumerTest {
  ...
  void shouldProcessEntriesAndFeedAllComponents() {
    ...
    when(stateMachine.evaluate(anyString(), anyBoolean())).thenReturn(ZetaDecision.none("key", null));
  ...
  void shouldBroadcastHotWhenStateMachineReturnsHot() {
    ...
    when(stateMachine.evaluate("hotKey", true)).thenReturn(ZetaDecision.hot("hotKey", null));
  ...
  void shouldBroadcastCoolWhenStateMachineReturnsCool() {
    ...
    when(stateMachine.evaluate("coolKey", false)).thenReturn(ZetaDecision.cool("coolKey", null));
  ...
  void shouldHandleCountAtMaxIntegerBoundary() {
    ...
    when(stateMachine.evaluate("bigKey", false)).thenReturn(ZetaDecision.none("bigKey", null));
  ...
  void shouldClampCountToMaxIntForTopK() {
    ...
    when(stateMachine.evaluate("hugeKey", false)).thenReturn(ZetaDecision.none("hugeKey", null));
  ...
  void shouldHandleNegativeCounts() {
    ...
    when(stateMachine.evaluate("negKey", false)).thenReturn(ZetaDecision.none("negKey", null));
  ...
  void shouldProcessMessageUnderStalenessBoundary() {
    ...
    when(stateMachine.evaluate("key", false)).thenReturn(ZetaDecision.none("key", null));
  ...
  void shouldContinueProcessingAfterStateMachineError() {
    ...
    when(stateMachine.evaluate("goodKey", false)).thenReturn(ZetaDecision.none("goodKey", null));
