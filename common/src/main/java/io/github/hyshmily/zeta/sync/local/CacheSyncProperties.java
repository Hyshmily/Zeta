 ...
 *
 * <p>Binds to the {@code zeta.sync} prefix in Spring configuration sources.
 * Each application instance creates an anonymous queue named
 * {@code zeta.sync:{instanceId}} bound to the configured FanoutExchange.
 *
...
@Data
@Validated
@ConfigurationProperties(prefix = "zeta.sync")
@Internal
public class CacheSyncProperties {
  ...
  private String queuePrefix = "zeta.sync";
