 ...
 */
@Internal
public final class ZetaConstants {

  /** Utility class — do not instantiate. */
  private ZetaConstants() {}
  ...
  /** Thread name prefix for general zeta operations. */
  public static final String THREAD_PREFIX_HOTKEY = "zeta-";
  /** Thread name prefix for cross-instance sync tasks. */
  public static final String THREAD_PREFIX_SYNC = "zeta-sync";
  /** Thread name prefix for worker-mode tasks. */
  public static final String THREAD_PREFIX_WORKER = "zeta-worker";
  /** Thread name prefix for report submission tasks. */
  public static final String THREAD_PREFIX_REPORT = "zeta-report";
  /** Thread name prefix for the shared scheduler pool. */
  public static final String THREAD_PREFIX_SCHEDULER = "zeta-scheduler";
  ...
  public static final String QUEUE_PREFIX_REPORT = "zeta.report.";
  ...
  public static final String REDIS_VERSION_KEY_PREFIX = "zeta:ver:";
  ...
  public static final String NO_SYNC_PUBLISHER = "No sync publisher found, please enable zeta.sync";

  /** AMQP message header key for the rule set version (rulesVersion). */
  public static final String AMQP_HEADER_RULES_VERSION = "rulesVersion";

  /** Redis key for the dynamic rules hash (blacklist / whitelist entries). */
  public static final String REDIS_KEY_RULES = "zeta:rules";

  /** Redis key prefix for distributed lock entries. */
  public static final String REDIS_LOCK_KEY_PREFIX = "zeta:lock:";

  /** Exchange name for app-to-Worker report routing (topic). */
  public static final String EXCHANGE_REPORT = "zeta.report.exchange";

  /** Exchange name for Worker heartbeat broadcasts (topic). */
  public static final String EXCHANGE_HEARTBEAT = "zeta.heartbeat.exchange";

  /** Exchange name for Worker HOT/COOL decision broadcasts (fanout). */
  public static final String EXCHANGE_BROADCAST = "zeta.send.exchange";

  /** Exchange name for cross-instance cache sync broadcasts (fanout). */
  public static final String EXCHANGE_SYNC = "zeta.sync.exchange";
}
