 ...
 * auto-incrementing counter starting at 1 (e.g. {@code zeta-scheduler-1}).
 */
@Internal
public class ZetaThreadFactory implements ThreadFactory {
   ...
   *                   (e.g. {@code "zeta-scheduler-"})
   */
  public ZetaThreadFactory(String namePrefix) {
