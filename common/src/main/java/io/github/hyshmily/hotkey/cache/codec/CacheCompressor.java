...
public interface CacheCompressor {
  ...
  @Nullable Object unwrap(@Nullable Object stored) throws IOException;

  CacheCompressor NONE = new CacheCompressor() {
    @Override public Object wrap(Object value) { return value; }
    @Override public Object unwrap(Object stored) { return stored; }
  };
}
