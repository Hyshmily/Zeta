...
class StateSnapshotTest {
  ...
  void shouldCreateSnapshotWithAllFields() {
    StateSnapshot snap = new StateSnapshot("k1", "CONFIRMED_HOT", 3, 0, 2.5, 1.0, 1);
  ...
  void shouldCreateSnapshotWithDefaultValues() {
    StateSnapshot snap = new StateSnapshot("k2", "COLD", 0, 0, 2.3026, 0.0, 0);
  ...
  void shouldSupportFluentAccessors() {
    StateSnapshot snap = new StateSnapshot("k4", "CANDIDATE_HOT", 2, 1, 2.0, 0.5, 2);
