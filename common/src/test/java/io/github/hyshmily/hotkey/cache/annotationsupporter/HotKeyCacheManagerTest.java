...
@DisplayName("HotKeyCacheManager tests")
class HotKeyCacheManagerTest {
  ...
  void setUp() {
    ...
    manager = new HotKeyCacheManager(hotKey, properties);
  }
  ...
  @Test
  @DisplayName("getCache creates new HotKeySpringCache on first access")
